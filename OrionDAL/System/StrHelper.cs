...
namespace System
{
    public static class StrHelper
    {
        ...
        public static string GetRemainingAfter(string searchText, string text)
        {
            string str;
            ...
            else if (!string.IsNullOrEmpty(searchText))
            {
                ...
                if (index >= 0)
                {
                    ...
                    str = (text.Length > index ? text.Substring(index) : "");
                }
                else
                {
                    str = text;
        ...
        public static string GetRemainingAfterLast(string searchText, string text)
        {
            string str;
            if (string.IsNullOrEmpty(text))
            {
        ...
        public static bool IsNullOrEmpty(this string pstring) {
            return pstring == null || string.IsNullOrEmpty(pstring);
        }

        public static bool IsNullOrWhiteSpace(this string pstring)
        {
            return pstring == null || string.IsNullOrWhiteSpace(pstring);
        }
        
        public static string  IsNull(this string pstring,string alternateString)
        {
            return string.IsNullOrEmpty(pstring) ? alternateString : pstring;
        }
    }
